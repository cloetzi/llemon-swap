...
A collection of use cases and examples for getting the most out of llemon-swap.

* [Lemonade lifecycle pool](lemonade/config.yaml) - two preferred defaults, one transient model, bounded resident-first scheduling, and automatic restoration.
